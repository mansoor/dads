      ...
      {!hostPrivileged && (
        <div className="px-4 py-3 bg-amber-950/40 border border-amber-800/50 rounded-xl">
          ...
          <p className="text-xs text-amber-400">
            Add the following to <code className="font-mono bg-amber-900/40 px-1 rounded">src/docker-compose.yml</code> under the <code className="font-mono bg-amber-900/40 px-1 rounded">dads</code> service:
          </p>
